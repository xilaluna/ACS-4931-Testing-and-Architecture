...
# Extract Class
class Recipe:
    def __init__(self, name, prep_time, is_veggie, food_type, cuisine, ingrediants, steps):
        self.name = name
    ...
    def information(self):
        ...
        for item in self.ingrediants:
            print(item, end=', ')
        print("Recipe:", self.steps)
        print("***")
...
for key, value in foods.items():
    recipe = Recipe(key, value[0], value[1], value[2],
